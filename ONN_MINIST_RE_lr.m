...
%weights_final_init=rand(num_output, hidden_layer_size);
...
learning_rate_list=[0.0005,0.0006,0.0007,0.0008,0.0009,0.001,0.0011,0.0012,0.0013,0.0014,0.0015];
...
%learning_rate = learning_rate_list(model_num);%学习率
